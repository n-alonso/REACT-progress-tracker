...
export function ShowDetails({ show }: ShowDetailsProps) {
    ...
    const { data: watchedEpisodes, isLoading: isLoadingWatchedEpisodes, isError: isErrorWatchedEpisodes, error: errorWatchedEpisodes } = useWatchedEpisodes(user?.id ?? 0, show.id);
